...
let ConsultaRepository = class ConsultaRepository extends typeorm_1.Repository {
};
ConsultaRepository = __decorate([
    (0, typeorm_1.EntityRepository)(consulta_entity_1.ConsultaEntity)
], ConsultaRepository);
